...
| **Datos agregados o de resumen** | Datos de alto nivel, que detallan cómo un grupo (por ejemplo, consumidores, campañas, regiones, etc.) interactúa con su negocio o actúa en él |
