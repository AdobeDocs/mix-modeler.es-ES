...
| **Volver a calificar un modelo** | Se ha agregado la capacidad de almacenar en déclencheur [la repuntuación de nuevos datos mediante un modelo existente](../models/overview.md#rescore). | 16 de noviembre de 2023 |
